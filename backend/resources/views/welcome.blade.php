...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Laravel') }} | My Portfolio</title>
        ...
        <div class="min-h-screen bg-gradient-to-b from-black to-gray-dark text-white">
            ...
            <section id="contact" class="py-24 bg-gradient-to-b from-black to-gray-dark relative">
                ...
                <div class="max-w-7xl mx-auto px-6 py-24 sm:px-8 md:px-12 lg:px-16 relative z-10">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:justify-items-end items-center justify-center">
                        {{-- Contact Form Livewire Component --}}
                        @livewire('contact-form')
                        <div class="max-w-md items-center justify-center flex">
                            <div class="space-y-6">
                                <a class="flex items-start gap-4" href="https://discord.com/users/925538473044234260" target="_blank" rel="noopener noreferrer">
                                    <div class="bg-gradient-to-b from-indigo-500/20 to-indigo-900/20 p-3 rounded-full">
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" class="text-indigo-500">
                                    ...
                                    <div>
                                        <h4 class="text-lg font-medium text-white">Discord</h4>
                                        <p class="text-white/60">@noedl</p>
                                    </div>
                                </a>

                                <a class="flex items-start gap-4" href="https://www.linkedin.com/in/noedl" target="_blank" rel="noopener noreferrer">
                                    <div class="bg-gradient-to-b from-blue-500/20 to-blue-900/20 p-3 rounded-full">
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" class="text-blue-500">
                                        <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                                        </svg>
                                    </div>
                                    <div>
                                        <h4 class="text-lg font-medium text-white">LinkedIn</h4>
                                        <p class="text-white/60">linkedin.com/in/noedl</p>
                                    </div>
                                </a>

                                <a class="flex items-start gap-4" href="https://www.instagram.com/yves.glezer" target="_blank" rel="noopener noreferrer">
                                    <div class="bg-gradient-to-b from-pink-500/20 to-pink-900/20 p-3 rounded-full">
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" class="text-pink-500">
                                    ...
                                    <div>
                                        <h4 class="text-lg font-medium text-white">Instagram</h4>
                                        <p class="text-white/60">@yves.glezer</p>
                                    </div>
                                </a>
                            </div>
                        </div>
